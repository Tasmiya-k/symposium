...
const eventDetails = {
    title: "Global Energy Scenario and Sustainability",
    description:
        "Dr. C. V. Prasad Rao, Managing Director of ADEPTUS CONSULTING, has over 44 years of experience in power generation, including both conventional and renewable energy. He has held senior management positions in leading power companies across India and abroad and has been recognized with numerous national and international awards for his contributions to sustainability and energy efficiency.",
    highlights: [
        "Understanding the global energy scenario and sustainability challenges.",
        "Exploring conventional and renewable energy innovations.",
        "Insights from a power sector expert with 44+ years of experience.",
        "Discussion on energy policies, efficiency, and future trends."
    ],
    date: "Thursday, 14th February 2025",
    time: "1:30 PM - 2:30 PM",
    venue: "B32, VESIT",
    speaker: {
        name: "Dr. C. V. Prasad Rao",
        designation: "Managing Director, ADEPTUS CONSULTING",
    },
    image: "/events/14feb_cvroa.webp",
};

const GlobalEnergyPage = () => {
    return (
        <div className="min-h-screen bg-white flex flex-col items-center p-8">
            <h1 className="text-5xl font-bold text-red-600 mb-6">Global Energy & Sustainability</h1>
