      ...
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        <div className="relative flex items-center justify-center pr-2">
          ...
          <div className="border-2 border-[#f60404] py-2 px-4 rounded-md relative">
            {/* Square Logo */}
            <img src="/headerlogo.png" alt="Symposium Logo" className="h-14 w-[400px] object-contain" />
          </div>
          {/* Legend-like text */}
        ...
        <div className="md:hidden">
          <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="text-red-600 focus:outline-none">
