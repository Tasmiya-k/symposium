...
const eventDetails = {
    ...
    description:
        "ISTE Approved Symposium on Technology Advancements for Sustainability (TAS’25) featuring an expert session on Medical Artificial Intelligence.",
    highlights: [
        "Insights into Medical AI advancements and its applications.",
        "Discussion on the role of AI in modern healthcare.",
        "Guest speaker from the medical industry sharing expertise.",
    ],
    ...
    executiveCommittee: ["Dr. (Mrs.) Shalu Chopra (HOD, INFT)"],
    organizingCommittee: [
